...
def main_menu_music(): #definicia na import a spustenie hudby v menu
    pygame.mixer.music.load("hudba.wav/mainmenu_1.wav")
    pygame.mixer.music.play(-1)

def music_1VPC(): #definicia na import a spustenie hudby v mode 1VPC
    pygame.mixer.music.load("hudba.wav/phonk_bass_1.wav")
    pygame.mixer.music.play(-1)

def music_1V1(): #definicia na import a spustenie hudby v mode 1V1
    pygame.mixer.music.load("hudba.wav/untitled14.wav")
    pygame.mixer.music.play(-1)
...
while run: #cyklus na beh celej hry
    main_menu_music() #povolanie hudby
